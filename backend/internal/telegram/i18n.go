...
/help — 本帮助`,
		...
		"n_user_blocked":    "⛔ <b>用户已被阻止</b>\n用户：<code>%s</code>\n原因：%s\n时间：%s",
		"n_user_restored":   "✅ <b>用户已恢复</b>\n用户：<code>%s</code>\n时间：%s",
		"n_daily_digest":    "📊 <b>3m-ui 每日摘要</b>\n用户数：%d\n已阻止：%d\n累计流量：%s\n时间：%s",
		"n_reason_disabled": "用户已禁用",
		"n_reason_expired":  "已过期",
		"n_reason_traffic":  "流量已用尽",
		"n_reason_other":    "凭据不可用",
		"n_traffic_warn":    "⚠️ <b>流量预警</b>\n用户：<code>%s</code>\n已用：%s / %s (%.0f%%)\n阈值：%d%%\n时间：%s",
		"n_traffic_gb_warn": "⚠️ <b>流量余额不足</b>\n用户：<code>%s</code>\n剩余：%s\n时间：%s",
		"n_expiry_warn":     "⏰ <b>到期预警</b>\n用户：<code>%s</code>\n到期：%s\n剩余：%s\n时间：%s",
		"n_cpu_high":        "🔥 <b>CPU 过高</b>\n使用率：<code>%.1f%%</code>（阈值 %d%%）",
		"n_mem_high":        "🧠 <b>内存过高</b>\n使用率：<code>%.1f%%</code>（阈值 %d%%）",
		"n_login_ok":        "🔐 <b>面板登录</b>\n用户：<code>%s</code>\nIP：<code>%s</code>\n时间：%s",
		"n_login_fail":      "❌ <b>登录失败</b>\n用户：<code>%s</code>\nIP：<code>%s</code>\n时间：%s",
		"n_core_crash":      "💥 <b>核心崩溃</b>\n错误：<code>%s</code>\n时间：%s\nℹ️ 将尝试自动重启",
		"n_report_title":    "📋 <b>3m-ui 定期报告</b>",
		"n_report_host":     "主机：<code>%s</code>",
		"n_report_time":     "时间：<code>%s</code>",
		"n_report_core":     "核心：<code>%s</code> v%s（运行 %s）",
		"n_report_sys":      "CPU：<code>%.1f%%</code>  内存：<code>%s / %s</code>  磁盘：<code>%.1f%%</code>",
		"n_report_users":    "用户：%d（在线 %d，不可用 %d）",
		"n_report_traffic":  "累计流量：%s",
		"n_report_expiry":   "即将到期：%d   已超额：%d",
		"n_event_time":      "时间：<code>%s</code>",
		"n_traffic_low":     "📦 <b>流量偏低</b>\n用户：<code>%s</code>\n剩余：%s / %s\n阈值：%dGB\n时间：%s",
		"n_expiry_days":     "📅 <b>到期提醒</b>\n用户：<code>%s</code>\n到期：%s\n剩余天数：%d\n时间：%s",
	},
	"zh-TW": {
...
/help — 本說明`,
		...
		"n_user_blocked":    "⛔ <b>使用者已被阻止</b>\n使用者：<code>%s</code>\n原因：%s\n時間：%s",
		"n_user_restored":   "✅ <b>使用者已恢復</b>\n使用者：<code>%s</code>\n時間：%s",
		"n_daily_digest":    "📊 <b>3m-ui 每日摘要</b>\n使用者數：%d\n已阻止：%d\n累計流量：%s\n時間：%s",
		"n_reason_disabled": "已停用",
		"n_reason_expired":  "已過期",
		"n_reason_traffic":  "流量已用盡",
		"n_reason_other":    "憑證不可用",
		"n_traffic_warn":    "⚠️ <b>流量預警</b>\n使用者：<code>%s</code>\n已用：%s / %s (%.0f%%)\n閾值：%d%%\n時間：%s",
		"n_traffic_gb_warn": "⚠️ <b>流量餘額不足</b>\n使用者：<code>%s</code>\n剩餘：%s\n時間：%s",
		"n_expiry_warn":     "⏰ <b>到期預警</b>\n使用者：<code>%s</code>\n到期：%s\n剩餘：%s\n時間：%s",
		"n_cpu_high":        "🔥 <b>CPU 過高</b>\n使用率：<code>%.1f%%</code>（閾值 %d%%）",
		"n_mem_high":        "🧠 <b>記憶體過高</b>\n使用率：<code>%.1f%%</code>（閾值 %d%%）",
		"n_login_ok":        "🔐 <b>面板登入</b>\n使用者：<code>%s</code>\nIP：<code>%s</code>\n時間：%s",
		"n_login_fail":      "❌ <b>登入失敗</b>\n使用者：<code>%s</code>\nIP：<code>%s</code>\n時間：%s",
		"n_core_crash":      "💥 <b>核心崩潰</b>\n錯誤：<code>%s</code>\n時間：%s\nℹ️ 將嘗試自動重啟",
		"n_report_title":    "📋 <b>3m-ui 定期報告</b>",
		"n_report_host":     "主機：<code>%s</code>",
		"n_report_time":     "時間：<code>%s</code>",
		"n_report_core":     "核心：<code>%s</code> v%s（運行 %s）",
		"n_report_sys":      "CPU：<code>%.1f%%</code>  記憶體：<code>%s / %s</code>  磁碟：<code>%.1f%%</code>",
		"n_report_users":    "使用者：%d（在線 %d，不可用 %d）",
		"n_report_traffic":  "累計流量：%s",
		"n_report_expiry":   "即將到期：%d   已超額：%d",
		"n_event_time":      "時間：<code>%s</code>",
		"n_traffic_low":     "📦 <b>流量偏低</b>\n使用者：<code>%s</code>\n剩餘：%s / %s\n閾值：%dGB\n時間：%s",
		"n_expiry_days":     "📅 <b>到期提醒</b>\n使用者：<code>%s</code>\n到期：%s\n剩餘天數：%d\n時間：%s",
	},
}
